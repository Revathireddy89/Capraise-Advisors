    ...
    <div className="pt-24">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-green-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold text-green-800 mb-6 motion-fade-in">Our Services</h1>
          <p className="text-xl text-green-700 max-w-3xl mx-auto motion-fade-in" style={{animationDelay: '0.2s'}}>Comprehensive financial and strategic solutions tailored to your unique business needs.</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-center gap-3 mb-12">
            <button
              ...
              className={`px-6 py-3 rounded-lg font-semibold transition ${activeTab === 'fundraising' ? 'bg-green-500 text-white shadow-lg' : 'bg-green-100 text-green-700 hover:bg-green-200'}`}
            >
              Fundraising
            </button>
            <button
              onClick={() => setActiveTab('restructuring')}
              className={`px-6 py-3 rounded-lg font-semibold transition ${activeTab === 'restructuring' ? 'bg-green-500 text-white shadow-lg' : 'bg-green-100 text-green-700 hover:bg-green-200'}`}
            >
              Restructuring
            </button>
            <button
              onClick={() => setActiveTab('advisory')}
              className={`px-6 py-3 rounded-lg font-semibold transition ${activeTab === 'advisory' ? 'bg-green-500 text-white shadow-lg' : 'bg-green-100 text-green-700 hover:bg-green-200'}`}
            >
              Advisory
            </button>
          </div>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition">
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Debt Syndication</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.1s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Private Equity Syndication</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.2s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Mergers & Acquisitions</h3>
              ...
              <div className="motion-scale bg-green-50 p-8 rounded-lg border border-green-200">
                <h3 className="text-2xl font-bold text-green-800 mb-4">Startup & VC Services</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="font-bold text-green-800 mb-4">Services for Startups</h4>
                  ...
                  <div>
                    <h4 className="font-bold text-green-800 mb-4">Services for VCs</h4>
                    <ul className="space-y-2 text-gray-700">
                      <li>• Deal sourcing</li>
                      <li>• Due diligence</li>
            ...
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition">
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Financial Restructuring</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.1s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Operational Restructuring</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.2s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Organizational Restructuring</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.3s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Strategic Restructuring</h3>
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition">
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Startup Advisory</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.1s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Capital Market Advisory</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.2s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Corporate Advisory</h3>
                ...
                <div className="motion-fade-in bg-white p-8 rounded-lg border border-green-200 hover:shadow-lg transition" style={{animationDelay: '0.3s'}}>
                  ...
                  <h3 className="text-2xl font-bold text-green-800 mb-4">Family Office Advisory</h3>
              ...
              <div className="bg-green-50 p-8 rounded-lg border border-green-200">
                <h3 className="text-2xl font-bold text-green-700 mb-4">Special Situations Advisory</h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {['Distressed Situations', 'Mergers & Acquisitions', 'Capital Structure Optimization', 'Litigation Support', 'Special Investments', 'Crisis Management'].map((item) => (
                    <div key={item} className="bg-white p-4 rounded border border-green-300">
                      <p className="text-sm text-green-700 font-semibold">{item}</p>
                    </div>
                  ))}
                </div>
              </div>
